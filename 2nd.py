...
# detection 29.85sec on video 5 and non detction 30.75 also on video 5
# import numpy as np
# import cv2
# import time
# import torch
...
# performace almost similar to v3
# v4 minor with self-recovery logic so that if KCF fails, the code will automatically fall back to YOLO face detection and reinitialize tracking without restarting the script.
# detection 29.85sec on video 5 and non detction 30.75 also on video 5
import numpy as np
import cv2
import time
